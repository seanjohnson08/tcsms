...
class session {
	...
	function create_session_id ($hash=0, $resident=0, $uid=0) {
	...
	function log_set_cookie ($user, $name, $value, $expire = 0) {
		global $CFG;
	...
	function create_session ($dbsess, $resident=0) {
		global $DB, $CFG;
	...
	function create_guest_session ($dbsess=array()) {
		$dbsess['uid'] = 0;
	...
	function update_session ($dbsess) {
		global $DB, $CFG;
	...
	function load_guest ($dbsess=array()) {
		global $STD, $CFG;
	...
	function check_login ($username, $password, $remember=0) {
		global $DB, $CFG, $STD;
