...
class component_adm_conf {
	...
	function do_delete_filter_entry () {
		global $IN, $STD, $DB, $CFG;
	...
	function rewrite_settings ($settings) {
		global $STD;
	...
	function build_array ($arr, $nesting=1) {
		$data = "array(\n";
