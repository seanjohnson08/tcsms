...
class component_search {
	...
	function get_search_string ($term) {
		global $STD;
	...
	function format_results ($data, $rawterms, $relevance) {
		global $STD;
	...
	function advanced_search () {
		...
		if (empty($IN['search'])) $IN['search'] = '';
		if (empty($IN['m'])) $IN['m'] = '';
		if (empty($IN['me'])) $IN['me'] = '0';
		if (empty($IN['c'])) $IN['c'] = '0';
		if (empty($IN['sh'])) $IN['sh'] = '0';
		if (empty($IN['d'])) $IN['d'] = '0';
		if (empty($IN['dd'])) $IN['dd'] = '0';
