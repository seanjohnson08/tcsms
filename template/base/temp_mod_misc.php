    ...
    <tr>
      ...
      <td style="width:47%;">
        ...
        <table class="sformtable" cellspacing="0" cellpadding="2">
          ...
          <tr>
            <td style="width:25px;height:25px;margin:auto;"><img src="{$STD->tags['global_image_path']}/disk.gif" alt="[O]"></td>
            <td>File Size:</td>
            <td>{$res['filesize']}</td>
          </tr>
          <tr>
            <td style="width:25px;height:25px;margin:auto;"><img src="{$STD->tags['global_image_path']}/gray_arrow.gif" alt="[O]"></td>
            <td>Views:</td>
            <td>{$res['views']}</td>
          </tr>
          <tr>
            <td style="width:25px;height:25px;margin:auto;"><img src="{$STD->tags['global_image_path']}/green_arrow.gif" alt="[O]"></td>
            <td>Downloads:</td>
            <td>{$res['downloads']}</td>
          </tr>
		  <tr>
            <td style="width:25px;height:25px;margin:auto;"><img src="{$STD->tags['global_image_path']}/favs.png" alt="[O]"></td>
            <td>Favorites:</td>
            <td>{$res['total_fav']}</td>
          </tr>
          <tr>
  ...
  <td class="sformlowline" style="padding:0px;text-align:left">
    <table cellpadding="2" style="border-spacing:0px;width:100%;height:100%;">
      ...
      <tr>
        ...
        <td style="vertical-align:bottom;width:100%;" colspan="2">
          <table style="border-spacing:0px;width:50%;">
            <tr>
              <td style="width:50%;font-size:8pt">
                Added: {$res['created']}
              </td>
...
<table class="sformtable" cellspacing="1">
<tr>
  <td class="sformleft">File Type</td>
