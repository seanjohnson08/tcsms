...
<body>
  ...
  <div class="header">
  <table style="background: url({$STD->tags['image_path']}/header_br.png); border-spacing:0px; width:100%;">
  <tr>
    <td style="padding:0px">
    <a href="{$STD->tags['root_url']}act=main"><img src="{$STD->tags['image_path']}/header.png" alt="Logo Image" class="logo" style="display:inline; vertical-align:middle"></a>
    </td>
  </tr>
  </table>
  </div>
  <div class="container">
  <table class="sidebarbg">
  <tr>
HTML;
}
...
<div class="menusection">
  ...
  <div class="menuitem">
    <input type="text" name="search" title="Search" size="14" class="sidetextbox"></div>
  <div class="menuitem">
...
<div class="menusection">
  <div class="menuitem">
    <input type="text" name="username" placeholder="username" title="Enter your username" size="13" class="sidetextbox"></div>
  <div class="menuitem">
    <input type="password" name="password" placeholder="password" title="Enter your password" size="13" class="sidetextbox"></div>
...
<div class="menusection">
  <div class="menuitem">
    ...
    <img src="{$STD->tags['global_image_path']}/signup.png" alt="Sign Up"></a></div>
  </div>
</div>
</form>
HTML;
...
return <<<HTML
<div class="menu">
<div class="menutitle"><a href="{$STD->tags['root_url']}act=user&amp;param=01&amp;uid={$STD->user['uid']}">{$username}</a></div>
<div class="menusection">
...
if ($STD->tags["skin"] == 3 || $STD->tags["skin"] == 6 || $STD->tags["skin"] == 7) {
  ...
  <table style="width:100%; margin-left: auto; margin-right: auto; border-spacing:0px;"><tr>
  <td style="background:url('.$STD->tags["image_path"].'/pipe_bg.gif); padding:0px;">
    <img src="'.$STD->tags["image_path"].'/pipe_left.gif" style="float:left" alt="Left Pipe Background"></td>
  <td style="background:url('.$STD->tags["image_path"].'/pipe_bg.gif); padding:0px;">
    <img src="'.$STD->tags["image_path"].'/pipe_right.gif" alt="Right Pipe Background" style="display:inline; vertical-align: top"><span class="boxpageheader">
  '.$title.'
  </span><img src="'.$STD->tags["image_path"].'/pipe_left.gif" alt="Left Pipe Background" style="display:inline; vertical-align: top"></td>
  <td style="background:url('.$STD->tags["image_path"].'/pipe_bg.gif); padding:0px;">
...
<tr>
 <td></td>
  <td>
  <br>
  <footer><div class="canvas_center copyright">
