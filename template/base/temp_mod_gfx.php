  ...
  <table class="sformtable" style="border-spacing:0;">
    <tr>
      ...
      <td style="width:47%;">
        ...
        <table class="sformtable" style="border-spacing:0;">
          <tr>
            <td style="width:25px;height:25px;text-align:center;"><img src="{$STD->tags['global_image_path']}/time.gif" alt="[O]"></td>
  ...
  <td class="sformlowline" style="padding:0px;text-align:left;height:100px;">
    <table cellpadding="2" style="border-spacing:0px;width:100%;height:100%;">
      <tr>
        ...
        <td "height:25px;width:25%;" class="sformstrip" style="background-position:right top;">
	      By: <b>{$res['author']}</b>
        </td>
        <td "height:25px;width:15%;" class="sformstrip" style="text-align:right;padding:2px">
          {$res['email_icon']} {$res['website_icon']}
        </td>
      </tr>
      <tr>
...
<tr>
  <td class="sformleft"><label for="thumbnail">Thumbnail</td>
